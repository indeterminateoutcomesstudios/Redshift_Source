...
/datum/job/captain
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/command/CO
...
/datum/job/hop
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/command/XO
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/command/XO/fleet
	)
	allowed_ranks = list(
...
/datum/job/rd
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/rd
...
/datum/job/cmo
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/command/cmo
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/command/cmo/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/fleet/o4,
...
/datum/job/chief_engineer
	...
	minimal_player_age = 21
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/command/chief_engineer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/command/chief_engineer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o3,
		/datum/mil_rank/fleet/o3,
...
/datum/job/hos
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/command/cos
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/command/cos/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o3,
		/datum/mil_rank/fleet/o3,
...
/datum/job/liaison
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/cl
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/representative
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/representative
	allowed_branches = list(/datum/mil_branch/civilian)
...
/datum/job/sea
	...
	economic_modifier = 8
	ideal_character_age = 45
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/command/sea/fleet
	allowed_branches = list(
...
/datum/job/bridgeofficer
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/command/bridgeofficer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/command/bridgeofficer/fleet
	)
	allowed_ranks = list(
...
/datum/job/bridgeofficer/get_description_blurb()
	return "You are a Bridge Officer. You are a very junior officer. You do not give orders of your own. You are subordinate to all of command. You handle matters on the bridge and report directly to the CO and XO. You take the folly's helm and pilot the Aquila if needed. You monitor bridge computer programs and communications and report relevant information to command."
...
/datum/job/pathfinder
	...
	economic_modifier = 7
	ideal_character_age = 35
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/exploration/pathfinder
...
/datum/job/explorer
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/exploration/explorer
	allowed_branches = list(/datum/mil_branch/expeditionary_corps)
...
/datum/job/senior_engineer
	...
	minimal_player_age = 14
	ideal_character_age = 40
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/engineering/senior_engineer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/engineering/senior_engineer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/fleet/e8,
...
/datum/job/engineer
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/engineering/engineer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/engineering/engineer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/fleet/e5,
...
/datum/job/engineer_contractor
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/engineering/contractor
	allowed_branches = list(/datum/mil_branch/civilian)
...
/datum/job/roboticist
	...
	alt_titles = list(
		...
		"Mechsuit Technician")
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/engineering/roboticist
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
...
/datum/job/warden
	...
	minimal_player_age = 14
	ideal_character_age = 35
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/security/brig_officer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/security/brig_officer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/fleet/e8,
		/datum/mil_rank/ec/e7,
...
/datum/job/detective
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/security/forensic_tech
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/security/forensic_tech/fleet,
	...
	allowed_ranks = list(
		...
		/datum/mil_rank/fleet/e4,
		/datum/mil_rank/fleet/e5,
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/folly/crew/security/forensic_tech/contractor,
		/datum/mil_rank/civ/marshal = /decl/hierarchy/outfit/job/folly/crew/security/forensic_tech/marshal
	)
...
/datum/job/officer
	...
	alt_titles = list()
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/security/maa
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/security/maa/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/e3,
		/datum/mil_rank/fleet/e2,
...
/datum/job/senior_doctor
	...
	alt_titles = list(
		"Surgeon",
		"Trauma Surgeon")
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/medical/senior
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/medical/senior/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o1,
		/datum/mil_rank/fleet/o2,
...
/datum/job/doctor
	...
	ideal_character_age = 40
	alt_titles = list(
		"Field Medic" = /decl/hierarchy/outfit/job/folly/crew/medical/doctor/medic,
		"Medical Technician",
		"Nurse")
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/medical/doctor/fleet
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps = /decl/hierarchy/outfit/job/folly/crew/medical/doctor,
		/datum/mil_branch/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/e3,
...
/datum/job/doctor_contractor
	...
	ideal_character_age = 30
	alt_titles = list(
		"Orderly" = /decl/hierarchy/outfit/job/folly/crew/medical/contractor/orderly,
		"Virologist" = /decl/hierarchy/outfit/job/folly/crew/medical/contractor/virologist,
		"Xenosurgeon" = /decl/hierarchy/outfit/job/folly/crew/medical/contractor/xenosurgeon,
		"Paramedic" = /decl/hierarchy/outfit/job/folly/crew/medical/contractor/paramedic)
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/medical/contractor
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
	min_skill = list(	/decl/hierarchy/skill/general/EVA			= SKILL_BASIC,
						/decl/hierarchy/skill/medical/medical		= SKILL_BASIC,
...
/datum/job/chemist
	...
	economic_modifier = 4
	ideal_character_age = 30
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/medical/contractor/chemist
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
...
/datum/job/psychiatrist
	...
	supervisors = "the Chief Medical Officer"
	alt_titles = list(
		"Psychiatrist" = /decl/hierarchy/outfit/job/folly/crew/medical/counselor/psychiatrist,
		"Chaplain" = /decl/hierarchy/outfit/job/folly/crew/medical/counselor/chaplain,
	)
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/medical/counselor
	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/expeditionary_corps = /decl/hierarchy/outfit/job/folly/crew/medical/counselor/ec,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/medical/counselor/fleet)
	allowed_ranks = list(
...
/datum/job/qm
	...
	minimal_player_age = 7
	ideal_character_age = 35
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/supply/deckofficer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/supply/deckofficer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o1 = /decl/hierarchy/outfit/job/folly/crew/supply/deckofficer/commissioned,
		/datum/mil_rank/fleet/o1,
		/datum/mil_rank/fleet/o2,
		/datum/mil_rank/fleet/e5,
		/datum/mil_rank/fleet/e6,
...
/datum/job/cargo_tech
	...
	ideal_character_age = 24
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/supply/tech
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/supply/tech/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/fleet/e2,
		/datum/mil_rank/ec/e3,
...
/datum/job/cargo_contractor
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/supply/contractor
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
	min_skill = list(	/decl/hierarchy/skill/organizational/bureaucracy	= SKILL_BASIC,
						/decl/hierarchy/skill/organizational/finance		= SKILL_BASIC,
...
/datum/job/janitor
	...
	alt_titles = list(
		"Janitor")
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/service/janitor
	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/expeditionary_corps = /decl/hierarchy/outfit/job/folly/crew/service/janitor/ec,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/service/janitor/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/civ/contractor,
		/datum/mil_rank/fleet/e2,
...
/datum/job/chef
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/service/cook
	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/expeditionary_corps = /decl/hierarchy/outfit/job/folly/crew/service/cook/ec,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/service/cook/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/civ/contractor,
		/datum/mil_rank/ec/e3,
...
/datum/job/bartender
	...
	ideal_character_age = 30
	selection_color = "#515151"
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/service/bartender
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
...
/datum/job/crew
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/crew/service/crewman
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/crew/service/crewman/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/e3,
		/datum/mil_rank/fleet/e2,
...
/datum/job/senior_scientist
	...
	alt_titles = list(
		"Research Supervisor")
	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/senior_scientist
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/nt_pilot
	...
	ideal_character_age = 40
	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/nt_pilot
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/scientist
	...
	alt_titles = list(
		...
		"Xenobiologist",
		"Xenobotanist",
		"Psychologist" = /decl/hierarchy/outfit/job/folly/passenger/research/scientist/psych)
	min_skill = list(	/decl/hierarchy/skill/organizational/bureaucracy	= SKILL_BASIC,
						/decl/hierarchy/skill/general/computer				= SKILL_BASIC,
						/decl/hierarchy/skill/research/devices				= SKILL_BASIC,
						/decl/hierarchy/skill/research/science				= SKILL_ADEPT)

	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/scientist
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/mining
	...
	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/prospector
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/guard
	...
	minimal_player_age = 3
	ideal_character_age = 25
	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/guard
	allowed_branches = list(/datum/mil_branch/civilian)
...
/datum/job/scientist_assistant
	...
	ideal_character_age = 30
	alt_titles = list(
		"Custodian" = /decl/hierarchy/outfit/job/folly/passenger/research/assist/janitor,
		"Testing Assistant" = /decl/hierarchy/outfit/job/folly/passenger/research/assist/testsubject,
		"Laboratory Technician",
		"Intern",
		"Clerk",
		"Field Assistant")

	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/research/assist
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/assistant
	...
	announced = FALSE
	alt_titles = list(
		"Journalist" = /decl/hierarchy/outfit/job/folly/passenger/passenger/journalist,
		"Historian",
		"Botanist",
		"Investor" = /decl/hierarchy/outfit/job/folly/passenger/passenger/investor,
		"Naturalist",
		"Ecologist",
		"Entertainer",
		...
		"Sociologist",
		"Trainer")
	outfit_type = /decl/hierarchy/outfit/job/folly/passenger/passenger
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(
...
/datum/job/offduty
	...
	selection_color = "#515151"
	outfit_type = /decl/hierarchy/outfit/job/folly/offduty
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/folly/offduty/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/e3,
		/datum/mil_rank/ec/e5,
		/datum/mil_rank/ec/e7,
		/datum/mil_rank/ec/o1 = /decl/hierarchy/outfit/job/folly/offduty/officer,
		/datum/mil_rank/ec/o3 = /decl/hierarchy/outfit/job/folly/offduty/officer,
...
/datum/job/merchant
	...
	minimal_player_age = 7
	create_record = 0
	outfit_type = /decl/hierarchy/outfit/job/folly/merchant
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/civ)
...
/datum/job/stowaway
	...
	create_record = 0
	account_allowed = 0
	outfit_type = /decl/hierarchy/outfit/job/folly/stowaway
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/civ)
	latejoin_at_spawnpoints = 1
	announced = FALSE
